...
st.write("C'est un programme de développement communautaire participatif,"
         ...
         "qui expriment leurs besoins en matière d'équipements et de services sociaux, "
         "d'appui aux activités génératrices de revenus, de renforcement des capacités et d'animation sociale.")